...
/**
 * Validates {@link WebMenu}.
 *
 * @author Ben Alex
 */
public class WebMenuValidator implements Validator {
	// ~ Methods
	// ========================================================================================================

	@SuppressWarnings("unchecked")
	public boolean supports(Class clazz) {
		return clazz.equals(WebMenu.class);
	}

	public void validate(Object obj, Errors errors) {
		WebMenu wc = (WebMenu) obj;
		...
		if ((wc.getPath() == null) || (wc.getPath().length() < 3)
				|| (wc.getPath().length() > 50)) {
